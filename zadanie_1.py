...
ax.set_title("Sprzedaż całkowita w kolejnych dniach kwartału 1", fontsize=14, verticalalignment='bottom')
ax.set_xlabel("Dzień", fontsize=7)
ax.set_ylabel("Sprzedaż w tyś.", fontsize=7)
